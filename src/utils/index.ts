...
const grabAllAdjacentCells = (cells: CellType[][], rowParam: number, colParam: number): {
 ...
 */
 ...
 export const openAdjacentCells = (cells: CellType[][], rowParam: number, colParam: number): CellType[][] => {
